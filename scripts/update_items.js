...
// Minimal, guaranteed-working item updater.
// Writes the same normalized hybrid dataset to both JSON copies.
  ...
  items: [
    {
      ...
      price: 1.85,
      category: "essentials",
      source_type: "bls_average_price",
      unit: "per lb",
    },
    {
      id: "eggs_dozen",
      name: "Eggs, Grade A Large (1 dozen)",
      price: 2.5,
      category: "essentials",
      source_type: "bls_average_price",
      unit: "per dozen",
    ...
    {
      id: "gas_regular_gallon",
      name: "Gasoline, Regular (1 gallon)",
      price: 3.65,
