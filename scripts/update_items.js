...
async function buildDataset() {
  ...
  return {
    ...
    items: [
      ...
      // ── Entertainment ──
      { id: "movie_ticket", name: "Movie Ticket", price: 16, category: "entertainment", source_type: "market_estimate", unit: "per ticket" },
      { id: "netflix_monthly", name: "Netflix (Standard, monthly)", price: 19.99, category: "entertainment", source_type: "market_price", unit: "monthly" },
      { id: "spotify_monthly", name: "Spotify Premium (monthly)", price: 12.99, category: "entertainment", source_type: "market_price", unit: "monthly" },
      ...
      { id: "hulu_monthly", name: "Hulu (No Ads, monthly)", price: 18.99, category: "entertainment", source_type: "market_price", unit: "monthly" },
      { id: "disney_plus_monthly", name: "Disney+ Premium (monthly)", price: 19, category: "entertainment", source_type: "market_price", unit: "monthly" },
      ...
      { id: "ferrari_296gtb", name: "Ferrari 296 GTB", price: 350000, category: "luxury", source_type: "market_price", unit: "each" },
      { id: "rolls_royce_ghost", name: "Rolls-Royce Ghost", price: 450000, category: "luxury", source_type: "market_estimate", unit: "each" },
      { id: "patek_nautilus", name: "Patek Philippe Nautilus Watch", price: 250000, category: "luxury", source_type: "market_price", unit: "each" },
      { id: "diamond_ring_5ct", name: "5-Carat Diamond Engagement Ring", price: 500000, category: "luxury", source_type: "market_estimate", unit: "each" },
      { id: "patek_grand_complications", name: "Patek Philippe Grand Complications", price: 350000, category: "luxury", source_type: "market_price", unit: "each" },
      { id: "luxury_watch_collection", name: "Curated Luxury Watch Collection (3 watches)", price: 700000, category: "luxury", source_type: "market_estimate", unit: "per collection" },
      { id: "helicopter_r66", name: "Robinson R66 Helicopter", price: 1400000, category: "luxury", source_type: "market_price", unit: "each" },
      { id: "aston_martin_db5", name: "Classic Aston Martin DB5 (1960s)", price: 650000, category: "luxury", source_type: "market_price", unit: "each" },
      { id: "bugatti_chiron", name: "Bugatti Chiron", price: 3000000, category: "luxury", source_type: "market_price", unit: "each" },
      { id: "artwork_notable", name: "Original Artwork (Notable Artist)", price: 8000000, category: "luxury", source_type: "market_estimate", unit: "each" },
      { id: "penthouse_nyc", name: "NYC Luxury Penthouse", price: 15000000, category: "luxury", source_type: "market_estimate", unit: "each" },
      ...
      // ── Experiences (luxury services / once-in-a-lifetime) ──
      { id: "first_class_rtw", name: "First-Class Around-the-World Trip for 2", price: 75000, category: "luxury", source_type: "market_estimate", unit: "per trip" },
      { id: "private_chef_year", name: "Private Chef for a Year", price: 150000, category: "luxury", source_type: "market_estimate", unit: "per year" },
      { id: "custom_wine_cellar", name: "Custom Wine Cellar (500-bottle)", price: 200000, category: "luxury", source_type: "market_estimate", unit: "each" },
      { id: "vintage_bordeaux_set", name: "Vintage Bordeaux Collection (12 bottles)", price: 250000, category: "luxury", source_type: "market_estimate", unit: "per set" },
      { id: "rare_scotch_collection", name: "Rare Scotch Whisky Collection (12 bottles)", price: 500000, category: "luxury", source_type: "market_estimate", unit: "per set" },
      { id: "safari_private_jet", name: "Ultra-Luxury African Safari for 2", price: 350000, category: "luxury", source_type: "market_price", unit: "per trip" },
      { id: "formula1_paddock", name: "F1 Paddock Club Weekend for 2", price: 15000, category: "luxury", source_type: "market_price", unit: "per weekend" },
      { id: "oceanfront_villa_week", name: "Malibu Oceanfront Villa (1 week)", price: 100000, category: "luxury", source_type: "market_estimate", unit: "per week" },
      { id: "bespoke_wardrobe", name: "Bespoke Savile Row Wardrobe", price: 50000, category: "luxury", source_type: "market_estimate", unit: "per wardrobe" },
      { id: "butler_year", name: "Live-in Butler for a Year", price: 100000, category: "luxury", source_type: "market_estimate", unit: "per year" },
      { id: "home_theater", name: "Private Home Theater System", price: 150000, category: "luxury", source_type: "market_estimate", unit: "each" },
      ...
      { id: "pet_lifetime_dog", name: "Buy & Support a Dog for Its Lifetime", price: 32000, category: "community", source_type: "akc_2026", unit: "one-time" },
